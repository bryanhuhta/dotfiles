...
##
## The installer clones nvm into ~/.nvm and checks out the pinned version;
...
# .zprofile exports NVM_DIR before nvm is installed, and the installer
# refuses to run when NVM_DIR points at a missing directory.
