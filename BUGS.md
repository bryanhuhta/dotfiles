...
Findings from an audit of this repository against chezmoi v2.72.0 on 2026-08-17. **Nothing here is fixed.** This file is a record so the issues are not rediscovered from scratch, and so the restructure work can be evaluated against a known baseline.
